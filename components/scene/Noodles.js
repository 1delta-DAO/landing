...
const material = new LayerMaterial({
  layers: [
    ...
    new Depth({ colorA: 'withe', colorB: colorB, alpha: 0.5, mode: 'add', near: 0, far: 1, origin: [1, 1, 1] }),
    new Fresnel({ mode: 'add', color: fresnel, intensity: 10.3, power: 2.5, bias: 0.1 }),7
...
function Noodle() {
  ...
  return (
    <Float position={position} speed={speed} rotationIntensity={10} floatIntensity={40} dispose={null} castShadow>
      <mesh scale={5} geometry={geometry} material={material} castShadow/>
    </Float>
  )
}
