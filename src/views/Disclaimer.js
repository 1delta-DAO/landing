      ...
      <section >
        <div className="container-sm" style={{ background: 'rgba(0, 0, 0, 0.5)' }}>
          <div style={{ marginTop: '80px' }}>
            ...
            <p className="m-0 text-color-transition-avg">
              <h3 className="text-color-bright-avg-hover">Introduction</h3>
            ...
            <h3 className="text-color-bright-avg-hover">Additional Rights</h3>
            <p className="m-0 text-color-transition-avg">
            ...
            <h3 className="text-color-bright-avg-hover"> Prohibited Activity</h3>
            <p className="m-0 text-color-transition-avg">
            ...
            <h3 className="text-color-bright-avg-hover">Not Registered with the SEC or Any Other Agency</h3>
            ...
            <h3 className="text-color-bright-avg-hover">Compliance and Tax Obligations</h3>
            <p className="m-0 text-color-transition-avg">
            ...
            <h3 className="text-color-bright-avg-hover"> Assumption of Risk</h3>
            <p className="m-0 text-color-transition-avg">
            ...
            <h3 className="text-color-bright-avg-hover">Third-Party Resources and Promotions </h3>
            ...
            <h3 className="text-color-bright-avg-hover">Release of Claims</h3>
            <p className="m-0 text-color-bright-avg-hover">
